...
export const MODEL_CHANNELS: readonly ProviderModel[] = [
  {
    id: "gpt-5.5",
    label: "gpt-5.5",
    sub: "OpenAI API · flagship · 1M ctx",
    group: "OpenAI",
    provider: "openai",
    model: "gpt-5.5",
  },
  {
    id: "gpt-5.4-mini",
    label: "gpt-5.4-mini",
    sub: "OpenAI API · faster · lower cost",
    group: "OpenAI",
    provider: "openai",
    model: "gpt-5.4-mini",
  },
  {
    id: "gpt-5.4-nano",
    label: "gpt-5.4-nano",
    sub: "OpenAI API · smallest · low latency",
    group: "OpenAI",
    provider: "openai",
    model: "gpt-5.4-nano",
  },
  {
    ...
    sub: "Google AI Studio · preview · 1M ctx",
    group: "Gemini",
    provider: "gemini",
  ...
  },
  {
    ...
    sub: "Google AI Studio · preview · fast · 1M ctx",
    group: "Gemini",
    provider: "gemini",
  ...
  },
  {
    ...
    sub: "Google AI Studio · preview · fast · light",
    group: "Gemini",
    provider: "gemini",
  ...
  },
  {
    ...
    sub: "Google AI Studio · stable · 1M ctx",
    group: "Gemini",
    provider: "gemini",
  ...
  },
  {
    ...
    sub: "Anthropic API · strongest · 1M ctx",
  ...
  },
  {
    ...
    sub: "Anthropic API · balanced · 1M ctx",
    group: "Anthropic (Claude)",
    provider: "anthropic",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #1 · Tencent · 262K ctx",
    group: "OpenRouter",
    provider: "openrouter",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #2 · Moonshot · 262K ctx",
    group: "OpenRouter",
    provider: "openrouter",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #3 · OpenAI · 1M ctx",
    group: "OpenRouter",
    provider: "openrouter",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #4 · Anthropic · 1M ctx",
    group: "OpenRouter",
    provider: "openrouter",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #5 · Anthropic · 1M ctx",
    group: "OpenRouter",
    provider: "openrouter",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #6 · Google · 1M ctx",
    group: "OpenRouter",
    provider: "openrouter",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #7 · xAI · 2M ctx",
    group: "OpenRouter",
    provider: "openrouter",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #8 · DeepSeek · 131K ctx",
    group: "OpenRouter",
    provider: "openrouter",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #9 · StepFun · 262K ctx",
    group: "OpenRouter",
    provider: "openrouter",
  ...
  },
  {
    ...
    sub: "OpenRouter daily #10 · DeepSeek · 1M ctx",
    group: "OpenRouter",
    provider: "openrouter",
...
export function resolveChannel(id: string | undefined | null): ProviderModel {
  ...
  const match = MODEL_CHANNELS.find((c) => c.id === id);
